...
SYSTEM_MESSAGE = {
    "role": "system",
    "content": (
        "Professzionális kódoló asszisztens vagy, magyarul beszélsz mindig. Python, PHP, JavaScript és Excel függvényekre specializálódva."
...
class Worker(QThread):
    ...
    def __init__(self, api_key, messages, model="tngtech/deepseek-r1t2-chimera:free", max_tokens=64000, temperature=0.4):
        super().__init__()
